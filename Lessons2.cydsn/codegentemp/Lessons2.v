// ======================================================================
// Lessons2.v generated from TopDesign.cysch
// 04/03/2026 at 15:59
...
module top ;
	...
	wire [0:0] tmpFB_0__Pin_LED3_net;
	wire [0:0] tmpIO_0__Pin_LED3_net;
	electrical [0:0] tmpSIOVREF__Pin_LED3_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_LED3
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED3_net[0:0]}),
		  .io({tmpIO_0__Pin_LED3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED3_net),
		  .annotation({Net_3}));


	wire [0:0] tmpFB_0__Pin_LED4_net;
	wire [0:0] tmpIO_0__Pin_LED4_net;
	electrical [0:0] tmpSIOVREF__Pin_LED4_net;

	cy_mxs40_gpio_v1_0
		#(.id("b1f2c51b-224c-474c-b3fb-37501e675354"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Pin_LED4
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED4_net[0:0]}),
		  .io({tmpIO_0__Pin_LED4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED4_net),
		  .annotation({Net_7}));
